...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $accion === 'crear') {
    ...
    if (empty($titulo) || empty($contenido)) {
        ...
        try {
            ...
            $consulta = "INSERT INTO noticias (titulo, contenido, autor_id, imagen, pie_foto, estado, fecha_publicacion) 
...
<head>
    ...
    <title>Gestión de Noticias - Bolivar por siempre</title>
        ...
        <aside class="sidebar" id="adminSidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="noticias.php" class="active">Gestión de Noticias</a></li>
